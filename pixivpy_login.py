...
class Ui_pixivpy_login(object):
    def setupUi(self, pixivpy_login):
        ...
        self.logo.setGeometry(QtCore.QRect(40, 40, 291, 81))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.remember.setGeometry(QtCore.QRect(40, 260, 121, 20))
        ...
        self.background.setGeometry(QtCore.QRect(0, 0, 371, 472))
    ...
    def retranslateUi(self, pixivpy_login):
        ...
        self.logo_text.setText(_translate("pixivpy_login", "让爬取变得更有乐趣"))
        self.quitButton.setText(_translate("pixivpy_login", "退出"))
        self.login_info.setText(_translate("pixivpy_login", "服务器异常"))
        self.remember.setText(_translate("pixivpy_login", "下次自动登录"))
